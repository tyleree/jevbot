...
BOUNDARY_CASES: list[tuple[buckets.BucketTable, list[tuple[float, str]]]] = [
    (
        ...
        [(0, "very_low"), (19.9, "very_low"), (20, "low"), (39.9, "low"), (40, "middle"), (59.9, "middle"),
         (60, "upper_middle"), (79.9, "upper_middle"), (80, "high"), (100, "high")],
    ),
    (
        buckets.PCTL5_RANGE,
    ...
    (
        buckets.CHANGE5,
        [(-0.16, "falling_sharply"), (-0.15, "falling"), (-0.051, "falling"), (-0.05, "steady"), (0.0, "steady"),
         (0.05, "steady"), (0.051, "rising"), (0.15, "rising"), (0.151, "rising_sharply")],
    ),
    (
    ...
    (
        buckets.DIST_ATR,
        [(-3.0, "stretched_far_below"), (-2.5, "extended_below"), (-1.01, "extended_below"), (-1.0, "near_average"),
         (0.0, "near_average"), (1.0, "near_average"), (1.01, "extended_above"), (2.5, "extended_above"),
         (2.51, "stretched_far_above")],
    ),
    (
        buckets.STREAK,
        [(-9, "long_down_streak"), (-4, "long_down_streak"), (-3, "short_down_streak"), (-2, "short_down_streak"),
         (-1, "no_streak"), (0, "no_streak"), (1, "no_streak"), (2, "short_up_streak"), (3, "short_up_streak"),
         (4, "long_up_streak"), (20, "long_up_streak")],
    ),
    (
        buckets.RV_CHANGE,
    ...
    (
        buckets.SIGMA5_GAP,
        [(-1.6, "large_gap_down"), (-1.5, "gap_down"), (-0.51, "gap_down"), (-0.5, "none"), (0.5, "none"),
         (0.51, "gap_up"), (1.5, "gap_up"), (1.51, "large_gap_up")],
    ),
    (
        buckets.SIGMA5_MOVE,
        [(-1.6, "large_decline"), (-1.5, "decline"), (-0.5, "quiet"), (0.5, "quiet"), (0.51, "advance"),
         (1.5, "advance"), (1.51, "large_advance")],
    ),
    (
        buckets.DD_52W,
        [(-0.21, "deep_drawdown"), (-0.20, "correction"), (-0.11, "correction"), (-0.10, "pullback"), (-0.051, "pullback"),
         (-0.05, "close_to_high"), (-0.021, "close_to_high"), (-0.02, "near_high"), (0.0, "near_high")],
    ),
    (buckets.IV_RV, [(0.89, "iv_cheap"), (0.9, "iv_fair"), (1.09, "iv_fair"), (1.1, "iv_rich"), (1.39, "iv_rich"), (1.4, "iv_very_rich")]),
    (
        buckets.EM,
        [(1, "under_half_percent"), (4, "under_half_percent"), (5, "half_to_1_percent"), (9, "half_to_1_percent"),
         (10, "1_to_2_percent"), (19, "1_to_2_percent"), (20, "2_to_4_percent"), (39, "2_to_4_percent"),
         (40, "4_to_6_percent"), (59, "4_to_6_percent"), (60, "6_to_10_percent"), (99, "6_to_10_percent"),
         (100, "10_percent_or_more"), (250, "10_percent_or_more")],
    ),
    (
        buckets.HOLD,
        [(1, "about_one_week"), (5, "about_one_week"), (6, "about_two_weeks"), (10, "about_two_weeks"),
         (11, "about_three_weeks"), (17, "about_three_weeks"), (18, "about_four_weeks"), (25, "about_four_weeks"),
         (26, "more_than_a_month")],
    ),
    (
        buckets.DTE4,
        [(0, "one_week_or_less"), (7, "one_week_or_less"), (8, "one_to_two_weeks"), (13, "one_to_two_weeks"),
         (14, "two_to_four_weeks"), (27, "two_to_four_weeks"), (28, "four_weeks_or_more"), (120, "four_weeks_or_more")],
    ),
    (
        buckets.HELD4,
        [(0, "just_opened"), (2, "just_opened"), (3, "about_one_week"), (7, "about_one_week"), (8, "two_to_three_weeks"),
         (15, "two_to_three_weeks"), (16, "more_than_three_weeks")],
    ),
    (
        buckets.SHORT_DIST,
        [(-0.1, "breached"), (0.0, "at_strike"), (0.24, "at_strike"), (0.25, "close"), (0.74, "close"),
         (0.75, "about_one_move"), (1.49, "about_one_move"), (1.5, "far")],
    ),
    (
        buckets.BREAKEVEN,
        [(-1.6, "far_short"), (-1.5, "short"), (-0.51, "short"), (-0.5, "just_short"), (-0.01, "just_short"),
         (0.0, "just_beyond"), (0.49, "just_beyond"), (0.5, "well_beyond")],
    ),
    (
        buckets.MOVE_SINCE_ENTRY,
        [(-1.1, "strongly_adverse"), (-1.0, "strongly_adverse"), (-0.99, "adverse"), (-0.25, "adverse"),
         (-0.24, "little_change"), (0.0, "little_change"), (0.24, "little_change"), (0.25, "favourable"),
         (0.99, "favourable"), (1.0, "strongly_favourable")],
    ),
    (
        buckets.PNL_LOSS,
        [(0.0, "flat"), (0.049, "flat"), (0.05, "small_loss"), (0.249, "small_loss"), (0.25, "moderate_loss"),
         (0.49, "moderate_loss"), (0.5, "loss"), (0.749, "loss"), (0.75, "large_loss")],
    ),
